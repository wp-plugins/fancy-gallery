...
<p>
  ...
  <input type="number" name="<?php Echo $this->Field_Name('thumb_width') ?>" id="<?php Echo $this->Field_Name('thumb_width') ?>" value="<?php Echo IntVal($this->Get_Meta('thumb_width')) ?>" class="short" <?php Disabled(True) ?> >px<span class="asterisk">*</span>
</p>

<p>
  <label for="<?php Echo $this->Field_Name('thumb_height') ?>"><?php Echo $this->t('Thumbnail height:') ?></label>
  <input type="number" name="<?php Echo $this->Field_Name('thumb_height') ?>" id="<?php Echo $this->Field_Name('thumb_height') ?>" value="<?php Echo Esc_Attr($this->Get_Meta('thumb_height')) ?>" class="short" <?php Disabled(True) ?> >px<span class="asterisk">*</span>
</p>
